...
int main()
{
   ...
   // --- 2. Create and Fill the VBO ---
   unsigned int VBO;
   glGenBuffers(1, &VBO);

   glBindVertexArray(VAO); // Bind our VAO first
   glBindBuffer(GL_ARRAY_BUFFER, VBO);
   glBufferData(GL_ARRAY_BUFFER, data_size, triangle_data_ptr, GL_STATIC_DRAW);
   ...
   // Color attribute (r, g, b) - Location 1
